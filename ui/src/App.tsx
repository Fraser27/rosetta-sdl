    ...
    <div className={`app-layout${collapsed ? ' sidebar-collapsed' : ''}`}>
      <aside className="sidebar">
        ...
        <nav>
          ...
          <NavItem to="/governance" icon={icons.governance} label="Governance" collapsed={collapsed} />
...
const icons = {
  ...
  governance: svg(<><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" /><path d="M9 12l2 2 4-4" /></>),
